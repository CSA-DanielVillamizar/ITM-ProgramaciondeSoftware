...
namespace BethanysPieShopHRM.App.Models
{
    public class MockDataService
    {
        ...
        private static void InitializeMockEmployees()
        {
            ...
            var e3 = new Employee();
            _employees = new List<Employee>() { e1, e2, e3 };
        }

        private static void InitializeMockJobCategories()
        {
        ...
        private static void InitializeMockCountries()
        {
